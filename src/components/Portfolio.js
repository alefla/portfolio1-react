  ...
  const openPopupboxNetflix = () => {
    const content = (
      <>
        ...
        <b>GitHub:</b> <a className="hyper-link" onClick={() => window.open("https://github.com/yourlinkhere")}>https://github.com/justexample</a>
      </>
    )
  ...
  const openPopupboxCityGuide = () => {
    const content = (
      <>
        ...
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ex cumque illo est expedita quos adipisci suscipit unde itaque qui perferendis.</p>
        <b>Demo:</b> <a className="hyper-link" onClick={() => window.open("https://something.herokuapp.com/", "_blank")}>https://something.herokuapp.com/</a>
        <br />
        <b>GitHub:</b> <a className="hyper-link" onClick={() => window.open("https://github.com/something/city-guide-app", "_blank")}>https://github.com/something/city-guide-app</a>
      </>
    )
    PopupboxManager.open({ content })
  }
  ...
  const openPopupboxPortfolio = () => {
    const content = (
      <>
        ...
        <b>Demo:</b> <a className="hyper-link" onClick={() => window.open("https://something.herokuapp.com/", "_blank")}>https://something.herokuapp.com/</a>
        <br />
        <b>GitHub:</b> <a className="hyper-link" onClick={() => window.open("https://github.com/something/portfilio", "_blank")}>https://github.com/something/portfilio</a>
      </>
    )
    PopupboxManager.open({ content })
  }
  ...
  const openPopupboxTaskManager = () => {
    const content = (
      <>
        ...
        <b>Demo:</b> <a className="hyper-link" onClick={() => window.open("https://something.herokuapp.com/", "_blank")}>https://something.herokuapp.com/</a>
        <br />
        <b>GitHub:</b> <a className="hyper-link" onClick={() => window.open("https://github.com/something/task-manager", "_blank")}>https://github.com/something/task-manager</a>
      </>
    )
    PopupboxManager.open({ content })
  }
